...
<Card bordered= {false} style={{width:'70%'}}>
      ...
      >
        ...
        <Col xs={24} md={12}>
          <Row>
            <Col xs={12}>
              <Typography.Title level={4}>Phone No:</Typography.Title>
            </Col>
            <Col xs={12}>
        ...
        <Col xs={24} md={12}>
          <Row>
            <Col xs={12}>
              <Typography.Title level={4}>Member No:</Typography.Title>
            </Col>
            <Col xs={12}>
        ...
        <Col xs={24} md={12}>
          <Row>
            <Col xs={12}>
              <Typography.Title level={4}>Updated Date:</Typography.Title>
            </Col>
            <Col xs={12}>
        ...
        <Col xs={24} md={12}>
          <Row>
            <Col xs={12}>
              <Typography.Title level={4}>Createtion Date:</Typography.Title>
            </Col>
            <Col xs={12}>
      ...
      <div className='button-container' style={{textAlign:'end'}}>
